...
<footer class="site-footer">
    ...
    <div class="footer-col-wrapper">
      ...
      <div class="footer-col footer-col-1 ten-padding">
        ...
        <ul class="social-media-list">
          <li>
            <a href="https://twitter.com/cityofatlanta">
              ...
              <span class="username">@cityofatlanta</span>
            </a>
          </li>
        </ul>
      </div>
  ...
  <script type="text/javascript">
  /* <![CDATA[ */
    $.backstretch("http://codeforamerica.github.io/atlanta-procurement-www/images/resurgens-opaque.png");
  /* ]]> */
  </script>
  ...
  <script type="text/javascript" charset="utf-8">
    BAROMETER.load('YE25XK6bGszPKbfk96T1P');
  </script>
</body>
</html>
